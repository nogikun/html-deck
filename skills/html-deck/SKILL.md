...
**材料を開く前に、この環境で利用できるスキルの一覧に目を通す。** 見るのは
**この1回だけ**。作り始めてから探し直さない。
...
**手順3 に入る前に、デザイン系が1つも無いことを確認したら、その旨を1行伝えてから
`references/quality-contract.md` の数値だけで進める** (黙って飛ばさない)。
デザイン系が1つでもあれば、**theme.css を書く前に必ず読む。**

拾うのはこの表に当たるものと、材料・依頼から要ると分かるものだけ。関係ないものまで
